...
public func openuikit_view_create() -> UnsafeMutableRawPointer { oukRetained(OUKView()) }

@_cdecl("openuikit_label_create")
public func openuikit_label_create() -> UnsafeMutableRawPointer { oukRetained(OUKLabel()) }
