...
- Create `tests/agent/AddressBookRuntime.swift`. It must import `AddressBook`, exercise
  meaningful implemented behavior, and print exactly `ADDRESSBOOK_AGENT_RUNTIME_OK` on success.
