...
func testImagePropertyKeyPayloads() {
    // MEASURED 2026-09-05 Apple ImageIO CFString payloads (macOS 26.1). Nested keys are short names.
    ...
    imageioRequire(keys.count == 652, "count")
}
