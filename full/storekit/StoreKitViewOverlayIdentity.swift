...
extension View {
    ...
    public func appStoreMerchandising(_ p0: Any? = nil) -> Self { self }
    public func appStoreOverlay(_ p0: Any? = nil) -> Self { self }
    ...
    public func currentEntitlementTask(_ p0: Any? = nil) -> Self { self }
    ...
    public func inAppPurchaseOptions(_ p0: Any? = nil) -> Self { self }
    ...
    public func manageSubscriptionsSheet(_ p0: Any? = nil) -> Self { self }
    ...
    public func offerCodeRedemption(_ p0: Any? = nil) -> Self { self }
    ...
    public func onInAppPurchaseCompletion(_ p0: Any? = nil) -> Self { self }
    public func onInAppPurchaseStart(_ p0: Any? = nil) -> Self { self }
    ...
    public func preferredSubscriptionOffer(_ p0: Any? = nil) -> Self { self }
    ...
    public func productDescription(_ p0: Any? = nil) -> Self { self }
    public func productIconBorder(_ p0: Any? = nil) -> Self { self }
    public func productViewStyle(_ p0: Any? = nil) -> Self { self }
    ...
    public func refundRequestSheet(_ p0: Any? = nil) -> Self { self }
    ...
    public func storeButton(_ p0: Any? = nil) -> Self { self }
    public func storeProductTask(_ p0: Any? = nil) -> Self { self }
    public func storeProductsTask(_ p0: Any? = nil) -> Self { self }
    ...
    public func subscriptionIntroductoryOffer(_ p0: Any? = nil) -> Self { self }
    public func subscriptionOfferViewButtonVisibility(_ p0: Any? = nil) -> Self { self }
    public func subscriptionOfferViewDetailAction(_ p0: Any? = nil) -> Self { self }
    public func subscriptionOfferViewStyle(_ p0: Any? = nil) -> Self { self }
    public func subscriptionPromotionalOffer(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStatusTask(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStoreButtonLabel(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStoreControlBackground(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStoreControlIcon(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStoreControlStyle(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStoreOptionGroupStyle(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStorePickerItemBackground(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStorePolicyDestination(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStorePolicyForegroundStyle(_ p0: Any? = nil) -> Self { self }
    public func subscriptionStoreSignInAction(_ p0: Any? = nil) -> Self { self }
