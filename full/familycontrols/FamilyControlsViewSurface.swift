...
// Identity View modifiers synthesized onto FamilyActivityPicker,
// FamilyActivityIconView, and FamilyActivityTitleView: View.
...
extension View {
    ...
    public func hash(_ p0: Any? = nil) -> Self { self }
