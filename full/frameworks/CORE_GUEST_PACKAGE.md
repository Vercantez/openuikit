...
`full/foundation/foundation_guest_sources.txt`. Its sixteen LF-terminated lines
...
The sixteen-source facade's names-only undefined-symbol inventory is also a
