...
# build/focus-onboarding-guest-x86_64. Run inside the production image with /w
# writable, /uikit and /machorun read-only, and the reviewed resource proof's
# bundles mounted read-only.
