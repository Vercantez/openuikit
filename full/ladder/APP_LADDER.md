...
| firefox-ios | MID / 10 | 3 / 4 | `UIMenuBuilder` 2 · `UICommandAlternate` 1 · `UITextItem` 1 | (was: `UISwipeGestureRecognizer` 10, landed `a1c0c6b9`; `UIToolbarDelegate` 2 and `NSCollectionLayoutAnchor` 2, landed `8427d5a0`.) 24 of the 28 remaining missing uses are stub-able (`UILargeContentViewerInteraction` 11 the largest). Next: menu builder / command alternates / text items; a browser engine remains outside the declaration score. |
