...
// Identity View modifiers synthesized onto AssignableDocumentView and
// AssignedWorkDocumentView. Linux has no SwiftUI layout engine; these compile
// as no-ops so the overlay census can be declared without inventing Apple layout.
