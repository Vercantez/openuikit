...
///
/// Each member takes a single optional `Any` parameter so identity calls
/// compile with zero arguments (FamilyControls/DeviceDiscoveryUI playbook).
...
extension View {
    ...
    public func addPassToWalletButtonStyle(_ p0: Any? = nil) -> Self { self }
    ...
    public func onApplePayCouponCodeChange(_ p0: Any? = nil) -> Self { self }
    public func onApplePayPaymentMethodChange(_ p0: Any? = nil) -> Self { self }
    public func onApplePayShippingContactChange(_ p0: Any? = nil) -> Self { self }
    public func onApplePayShippingMethodChange(_ p0: Any? = nil) -> Self { self }
    ...
    public func payLaterViewAction(_ p0: Any? = nil) -> Self { self }
    public func payLaterViewDisplayStyle(_ p0: Any? = nil) -> Self { self }
    public func payWithApplePayButtonDisableCardArt(_ p0: Any? = nil) -> Self { self }
    public func payWithApplePayButtonStyle(_ p0: Any? = nil) -> Self { self }
    ...
    public func verifyIdentityWithWalletButtonStyle(_ p0: Any? = nil) -> Self { self }
