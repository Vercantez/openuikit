...
/// real module is imported; the isolated host has no SwiftUI, so PassKit
/// overlay types that conform to View expose the method names from the canonical
/// synthesized surface as no-op lookalikes.
enum _PassKitViewSurfaceMarker {}
...
extension View {
    ...
    public func addPassToWalletButtonStyle<T0>(_ p0: T0) -> Self { self }
    public func payLaterViewDisplayStyle<T0>(_ p0: T0) -> Self { self }
    public func payLaterViewAction<T0>(_ p0: T0) -> Self { self }
    public func onApplePayCouponCodeChange<T0>(_ p0: T0) -> Self { self }
    public func payWithApplePayButtonStyle<T0>(_ p0: T0) -> Self { self }
    public func onApplePayPaymentMethodChange<T0>(_ p0: T0) -> Self { self }
    public func onApplePayShippingMethodChange<T0>(_ p0: T0) -> Self { self }
    public func onApplePayShippingContactChange<T0>(_ p0: T0) -> Self { self }
    public func payWithApplePayButtonDisableCardArt<T0>(_ p0: T0) -> Self { self }
    public func verifyIdentityWithWalletButtonStyle<T0>(_ p0: T0) -> Self { self }
}
#endif
