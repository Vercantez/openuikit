...
// Identity View modifiers synthesized onto JournalingSuggestionsPicker
// because it conforms to View. Linux has no SwiftUI layout engine;
// these compile as no-ops so the overlay census can be declared
// without inventing layout. Compiled only when SwiftUI is absent.

#if !canImport(SwiftUI)
extension View {
    public func onMapCameraChange(frequency _: Any? = nil, _ : Any? = nil) -> Self { self }
    public func mapControls(_ : Any? = nil) -> Self { self }
    public func lookAroundViewer(isPresented _: Any? = nil, initialScene _: Any? = nil, allowsNavigation _: Any? = nil, showsRoadLabels _: Any? = nil, pointsOfInterest _: Any? = nil, onDismiss _: Any? = nil) -> Self { self }
    public func lookAroundViewer(isPresented _: Any? = nil, scene _: Any? = nil, allowsNavigation _: Any? = nil, showsRoadLabels _: Any? = nil, pointsOfInterest _: Any? = nil, onDismiss _: Any? = nil) -> Self { self }
    public func mapItemDetailSheet(isPresented _: Any? = nil, item _: Any? = nil, displaysMap _: Any? = nil) -> Self { self }
    public func mapItemDetailSheet(item _: Any? = nil, displaysMap _: Any? = nil) -> Self { self }
    public func mapControlVisibility(_ : Any? = nil) -> Self { self }
    public func mapItemDetailPopover(isPresented _: Any? = nil, item _: Any? = nil, displaysMap _: Any? = nil, attachmentAnchor _: Any? = nil, arrowEdge _: Any? = nil) -> Self { self }
    public func mapItemDetailPopover(isPresented _: Any? = nil, item _: Any? = nil, displaysMap _: Any? = nil, attachmentAnchor _: Any? = nil) -> Self { self }
    public func mapItemDetailPopover(item _: Any? = nil, displaysMap _: Any? = nil, attachmentAnchor _: Any? = nil, arrowEdge _: Any? = nil) -> Self { self }
    public func mapItemDetailPopover(item _: Any? = nil, displaysMap _: Any? = nil, attachmentAnchor _: Any? = nil) -> Self { self }
    public func mapCameraKeyframeAnimator(trigger _: Any? = nil, keyframes _: Any? = nil) -> Self { self }
    public func mapFeatureSelectionContent(content _: Any? = nil) -> Self { self }
    public func mapFeatureSelectionDisabled(_ : Any? = nil) -> Self { self }
    public func mapFeatureSelectionAccessory(_ : Any? = nil) -> Self { self }
    public func mapScope(_ : Any? = nil) -> Self { self }
    public func mapStyle(_ : Any? = nil) -> Self { self }
    public func journalingSuggestionsPicker(isPresented _: Any? = nil, journalingSuggestionToken _: Any? = nil, onCompletion _: Any? = nil) -> Self { self }
    public func journalingSuggestionsPicker(isPresented _: Any? = nil, onCompletion _: Any? = nil) -> Self { self }
