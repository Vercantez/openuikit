...
/// real module is imported; the isolated host has no SwiftUI, so the WebKit
/// overlay `WebView` (which conforms to `View`) exposes the method names from
/// the canonical overlay surface as no-op lookalikes.
///
/// Each member takes a single optional `Any` parameter so identity calls
/// compile with zero arguments (FamilyControls/PassKit/StoreKit playbook).
...
extension View {
    ...
    public func webViewBackForwardNavigationGestures(_ p0: Any? = nil) -> Self { self }
    public func webViewContentBackground(_ p0: Any? = nil) -> Self { self }
    public func webViewContextMenu(_ p0: Any? = nil) -> Self { self }
    public func webViewElementFullscreenBehavior(_ p0: Any? = nil) -> Self { self }
    public func webViewLinkPreviews(_ p0: Any? = nil) -> Self { self }
    public func webViewMagnificationGestures(_ p0: Any? = nil) -> Self { self }
    public func webViewOnScrollGeometryChange(_ p0: Any? = nil) -> Self { self }
    public func webViewScrollInputBehavior(_ p0: Any? = nil) -> Self { self }
    public func webViewScrollPosition(_ p0: Any? = nil) -> Self { self }
    public func webViewTextSelection(_ p0: Any? = nil) -> Self { self }
