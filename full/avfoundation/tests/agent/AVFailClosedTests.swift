...
func testAVMediaTypeAndCharacteristicRawValues() {
    precondition(AVMediaType.video.rawValue == "vide")
    precondition(AVMediaType.audio.rawValue == "soun")
    precondition(AVMediaType.text.rawValue == "text")
    precondition(AVMediaType.closedCaption.rawValue == "clcp")
    precondition(AVMediaType.subtitle.rawValue == "sbtl")
    precondition(AVMediaType.timecode.rawValue == "tmcd")
    precondition(AVMediaType.metadata.rawValue == "meta")
    precondition(AVMediaType.muxed.rawValue == "muxx")
    precondition(AVMediaType.haptic.rawValue == "hapt")
    precondition(AVMediaType.metadataObject.rawValue == "metadataObject")
    precondition(AVMediaType.depthData.rawValue == "dpth")
    precondition(AVMediaType.auxiliaryPicture.rawValue == "auxv")
    precondition(AVMediaCharacteristic.visual.rawValue == "AVMediaCharacteristicVisual")
    precondition(AVMediaCharacteristic.audible.rawValue == "AVMediaCharacteristicAudible")
    precondition(AVMediaCharacteristic.legible.rawValue == "AVMediaCharacteristicLegible")
    precondition(AVMediaCharacteristic.frameBased.rawValue == "AVMediaCharacteristicFrameBased")
    precondition(AVMediaCharacteristic.easyToRead.rawValue == "public.easy-to-read")
    precondition(AVMediaCharacteristic.describesVideoForAccessibility.rawValue == "public.accessibility.describes-video")
    precondition(AVMediaCharacteristic.describesMusicAndSoundForAccessibility.rawValue == "public.accessibility.describes-music-and-sound")
    precondition(AVMediaCharacteristic.transcribesSpokenDialogForAccessibility.rawValue == "public.accessibility.transcribes-spoken-dialog")
    precondition(AVMediaCharacteristic.containsHDRVideo.rawValue == "public.contains-hdr-video")
    precondition(AVMediaCharacteristic.containsStereoMultiviewVideo.rawValue == "public.contains-stereo-multiview-video")
    precondition(AVMediaCharacteristic.containsAlphaChannel.rawValue == "public.contains-alpha-channel")
    precondition(AVMediaCharacteristic.enhancesSpeechIntelligibility.rawValue == "public.accessibility.enhances-speech-intelligibility")
    precondition(AVMediaCharacteristic.usesWideGamutColorSpace.rawValue == "public.uses-wide-gamut-color-space")
    precondition(AVMediaCharacteristic.isMainProgramContent.rawValue == "public.main-program-content")
    precondition(AVMediaCharacteristic.isAuxiliaryContent.rawValue == "public.auxiliary-content")
    precondition(AVMediaCharacteristic.languageTranslation.rawValue == "public.translation")
}

func testAVVideoCodecAndApertureRawValues() {
    precondition(AVVideoCodecType.h264.rawValue == "avc1")
    precondition(AVVideoCodecType.hevc.rawValue == "hvc1")
    precondition(AVVideoCodecType.jpeg.rawValue == "jpeg")
    precondition(AVVideoCodecType.JPEGXL.rawValue == "jxlc")
    precondition(AVVideoCodecType.proRes422.rawValue == "apcn")
    precondition(AVVideoCodecType.proRes422HQ.rawValue == "apch")
    precondition(AVVideoCodecType.proRes422LT.rawValue == "apcs")
    precondition(AVVideoCodecType.proRes422Proxy.rawValue == "apco")
    precondition(AVVideoCodecType.proRes4444.rawValue == "ap4h")
    precondition(AVVideoCodecType.appleProRes4444XQ.rawValue == "ap4x")
    precondition(AVVideoCodecType.proResRAW.rawValue == "aprn")
    precondition(AVVideoCodecType.proResRAWHQ.rawValue == "aprh")
    precondition(AVVideoCodecType.hevcWithAlpha.rawValue == "muxa")
