...
func visionRunFocusedTests() {
    ...
    testHomographicRegistrationClassical()
    testHomographicRegistrationIdentical()
    testHomographicRegistrationMissingTarget()
    testTrackHomographicSequential()
    testOverlayTrackHomographicSequential()
    testOverlayHomographicObservationValues()
    testForegroundInstanceMaskClassical()
    testOverlayForegroundInstanceMask()
    testDetectTrajectoriesClassical()
    testDetectTrajectoriesStaticEmpty()
    testOverlayDetectTrajectories()
