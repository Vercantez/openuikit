...
- Create `tests/agent/OpenGLESRuntime.swift`. It must import `OpenGLES`, exercise
  meaningful implemented behavior, and print exactly `OPENGLES_AGENT_RUNTIME_OK` on success.
