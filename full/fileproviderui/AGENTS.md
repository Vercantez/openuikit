...
- Create `tests/agent/FileProviderUIRuntime.swift`. It must import `FileProviderUI`, exercise
  meaningful implemented behavior, and print exactly `FILEPROVIDERUI_AGENT_RUNTIME_OK` on success.
