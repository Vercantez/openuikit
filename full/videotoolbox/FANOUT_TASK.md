...
The immutable seed contains 957 unique public precise identifiers and
860 symbol-graph relationships. The acceptance floor is
96 nondeferred (`implemented` or `declared`) identifiers: min(150, max(50, ceil(10% of exact public symbols))).
