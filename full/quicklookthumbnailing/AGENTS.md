...
- Create `tests/agent/QuickLookThumbnailingRuntime.swift`. It must import `QuickLookThumbnailing`, exercise
  meaningful implemented behavior, and print exactly `QUICKLOOKTHUMBNAILING_AGENT_RUNTIME_OK` on success.
