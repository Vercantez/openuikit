...
func testActivityStateUpdatesMap() {
    activityKitRunAsync {
...
func testActivityStateUpdatesThrowingMap() {
    activityKitRunAsync {
...
func testActivityStateUpdatesCompactMap() {
    activityKitRunAsync {
...
func testActivityStateUpdatesThrowingCompactMap() {
    activityKitRunAsync {
...
func testActivityStateUpdatesFilter() {
    activityKitRunAsync {
...
func testActivityStateUpdatesDropFirst() {
    activityKitRunAsync {
...
func testActivityStateUpdatesDropWhile() {
    activityKitRunAsync {
...
func testActivityStateUpdatesPrefix() {
    activityKitRunAsync {
...
func testActivityStateUpdatesPrefixWhile() {
    activityKitRunAsync {
...
func testActivityStateUpdatesContainsWhere() {
    activityKitRunAsync {
...
func testActivityStateUpdatesFirstWhere() {
    activityKitRunAsync {
...
func testActivityStateUpdatesAllSatisfy() {
    activityKitRunAsync {
...
func testActivityStateUpdatesFlatMap() {
    activityKitRunAsync {
...
func testActivityStateUpdatesContains() {
    activityKitRunAsync {

    activityKitReset()
    let activity = try! activityKitRequest("op")
    let sequence = activity.activityStateUpdates
        let found = await sequence.contains(.active)
