...
- Create `tests/agent/DeviceDiscoveryUIRuntime.swift`. It must import `DeviceDiscoveryUI`, exercise
  meaningful implemented behavior, and print exactly `DEVICEDISCOVERYUI_AGENT_RUNTIME_OK` on success.
