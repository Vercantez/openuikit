...
- Create `tests/agent/ThreadNetworkRuntime.swift`. It must import `ThreadNetwork`, exercise
  meaningful implemented behavior, and print exactly `THREADNETWORK_AGENT_RUNTIME_OK` on success.
