...
open class MTRBaseClusterTimeSynchronization: MTRGenericBaseCluster {
    ...
    open class func readAttributeDSTOffsetListMaxSize(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeDSTOffset(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeDefaultNTP(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (String?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    ...
    open class func readAttributeGranularity(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeLocalTime(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeNTPServerAvailable(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeSupportsDNSResolve(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeTimeSource(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeTimeZoneDatabase(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeTimeZoneListMaxSize(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeTimeZone(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeTrustedTimeSource(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (MTRTimeSynchronizationClusterTrustedTimeSourceStruct?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeUTCTime(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    ...
    open func readAttributeDSTOffsetListMaxSize(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeDSTOffset(completion: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeDefaultNTP(completion: @escaping (String?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    ...
    open func readAttributeGranularity(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeLocalTime(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeNTPServerAvailable(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeSupportsDNSResolve(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeTimeSource(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeTimeZoneDatabase(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeTimeZoneListMaxSize(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeTimeZone(completion: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeTrustedTimeSource(completion: @escaping (MTRTimeSynchronizationClusterTrustedTimeSourceStruct?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeUTCTime(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func setDSTOffsetWith(_ params: MTRTimeSynchronizationClusterSetDSTOffsetParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func setDefaultNTPWith(_ params: MTRTimeSynchronizationClusterSetDefaultNTPParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func setTimeZoneWith(_ params: MTRTimeSynchronizationClusterSetTimeZoneParams, completion: @escaping (MTRTimeSynchronizationClusterSetTimeZoneResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func setTrustedTimeSourceWith(_ params: MTRTimeSynchronizationClusterSetTrustedTimeSourceParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func setUTCTimeWith(_ params: MTRTimeSynchronizationClusterSetUTCTimeParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    ...
    open func subscribeAttributeDSTOffsetListMaxSize(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeDSTOffset(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeDefaultNTP(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (String?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    ...
    open func subscribeAttributeGranularity(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeLocalTime(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeNTPServerAvailable(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeSupportsDNSResolve(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeTimeSource(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeTimeZoneDatabase(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeTimeZoneListMaxSize(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeTimeZone(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeTrustedTimeSource(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (MTRTimeSynchronizationClusterTrustedTimeSourceStruct?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeUTCTime(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
...
open class MTRClusterTimeSynchronization: MTRGenericCluster {
    ...
    open func readAttributeDSTOffsetListMaxSize(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("DSTOffsetListMaxSize", params: params)
    }
    open func readAttributeDSTOffset(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("DSTOffset", params: params)
    }
    open func readAttributeDefaultNTP(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("DefaultNTP", params: params)
    }
    open func readAttributeFeatureMap(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeGranularity(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("Granularity", params: params)
    }
    open func readAttributeLocalTime(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("LocalTime", params: params)
    }
    open func readAttributeNTPServerAvailable(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("NTPServerAvailable", params: params)
    }
    open func readAttributeSupportsDNSResolve(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("SupportsDNSResolve", params: params)
    }
    open func readAttributeTimeSource(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("TimeSource", params: params)
    }
    open func readAttributeTimeZoneDatabase(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("TimeZoneDatabase", params: params)
    }
    open func readAttributeTimeZoneListMaxSize(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("TimeZoneListMaxSize", params: params)
    }
    open func readAttributeTimeZone(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("TimeZone", params: params)
    }
    open func readAttributeTrustedTimeSource(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("TrustedTimeSource", params: params)
    }
    open func readAttributeUTCTime(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("UTCTime", params: params)
    }
    open func setDSTOffsetWith(_ params: MTRTimeSynchronizationClusterSetDSTOffsetParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func setDefaultNTPWith(_ params: MTRTimeSynchronizationClusterSetDefaultNTPParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func setTimeZoneWith(_ params: MTRTimeSynchronizationClusterSetTimeZoneParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping (MTRTimeSynchronizationClusterSetTimeZoneResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func setTrustedTimeSourceWith(_ params: MTRTimeSynchronizationClusterSetTrustedTimeSourceParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func setUTCTimeWith(_ params: MTRTimeSynchronizationClusterSetUTCTimeParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
...
open class MTRBaseClusterIdentify: MTRGenericBaseCluster {
    ...
    open class func readAttributeIdentifyTime(withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (attributeCacheContainer, endpoint, queue, completionHandler)
        mtrInvokeFailClosed(completionHandler)
    }
    open class func readAttributeIdentifyTime(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeIdentifyType(withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (attributeCacheContainer, endpoint, queue, completionHandler)
        mtrInvokeFailClosed(completionHandler)
    }
    open class func readAttributeIdentifyType(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open func identify(with params: MTRIdentifyClusterIdentifyParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func identify(with params: MTRIdentifyClusterIdentifyParams, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func readAttributeIdentifyTime(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeIdentifyTime(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func readAttributeIdentifyType(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeIdentifyType(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func subscribeAttributeIdentifyTime(withMinInterval minInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished subscriptionEstablishedHandler: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (minInterval, maxInterval, params, subscriptionEstablishedHandler, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeIdentifyTime(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeIdentifyType(withMinInterval minInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished subscriptionEstablishedHandler: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (minInterval, maxInterval, params, subscriptionEstablishedHandler, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeIdentifyType(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func triggerEffect(with params: MTRIdentifyClusterTriggerEffectParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func triggerEffect(with params: MTRIdentifyClusterTriggerEffectParams, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func writeAttributeIdentifyTime(withValue value: NSNumber, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (value, completion)
        mtrFailClosed(completion)
    }
    open func writeAttributeIdentifyTime(withValue value: NSNumber, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (value, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func writeAttributeIdentifyTime(withValue value: NSNumber, params: MTRWriteParams?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (value, params, completion)
        mtrFailClosed(completion)
    }
    open func writeAttributeIdentifyTime(withValue value: NSNumber, params: MTRWriteParams?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (value, params, completionHandler)
        mtrFailClosed(completionHandler)
    }
...
open class MTRClusterIdentify: MTRGenericCluster {
    ...
    open func identify(with params: MTRIdentifyClusterIdentifyParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func identify(with params: MTRIdentifyClusterIdentifyParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func readAttributeIdentifyTime(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("IdentifyTime", params: params)
    }
    open func readAttributeIdentifyType(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("IdentifyType", params: params)
    }
    open func triggerEffect(with params: MTRIdentifyClusterTriggerEffectParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func triggerEffect(with params: MTRIdentifyClusterTriggerEffectParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func writeAttributeIdentifyTime(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("IdentifyTime", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeIdentifyTime(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("IdentifyTime", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    public convenience init?(device: MTRDevice, endpoint: UInt16, queue: dispatch_queue_t)
    {
        self.init(device: device, endpointID: NSNumber(value: endpoint), queue: queue)
...
open class MTRBaseClusterGroups: MTRGenericBaseCluster {
    ...
    open class func readAttributeNameSupport(withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (attributeCacheContainer, endpoint, queue, completionHandler)
        mtrInvokeFailClosed(completionHandler)
    }
    open class func readAttributeNameSupport(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open func addGroupIfIdentifying(with params: MTRGroupsClusterAddGroupIfIdentifyingParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func addGroupIfIdentifying(with params: MTRGroupsClusterAddGroupIfIdentifyingParams, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func addGroup(with params: MTRGroupsClusterAddGroupParams, completion: @escaping (MTRGroupsClusterAddGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func addGroup(with params: MTRGroupsClusterAddGroupParams, completionHandler: @escaping (MTRGroupsClusterAddGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func getGroupMembership(with params: MTRGroupsClusterGetGroupMembershipParams, completion: @escaping (MTRGroupsClusterGetGroupMembershipResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func getGroupMembership(with params: MTRGroupsClusterGetGroupMembershipParams, completionHandler: @escaping (MTRGroupsClusterGetGroupMembershipResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func readAttributeNameSupport(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeNameSupport(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func removeAllGroups(completion: @escaping ((any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func removeAllGroups(completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func removeAllGroups(with params: MTRGroupsClusterRemoveAllGroupsParams?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func removeAllGroups(with params: MTRGroupsClusterRemoveAllGroupsParams?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func removeGroup(with params: MTRGroupsClusterRemoveGroupParams, completion: @escaping (MTRGroupsClusterRemoveGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func removeGroup(with params: MTRGroupsClusterRemoveGroupParams, completionHandler: @escaping (MTRGroupsClusterRemoveGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func subscribeAttributeNameSupport(withMinInterval minInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished subscriptionEstablishedHandler: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (minInterval, maxInterval, params, subscriptionEstablishedHandler, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeNameSupport(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func viewGroup(with params: MTRGroupsClusterViewGroupParams, completion: @escaping (MTRGroupsClusterViewGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func viewGroup(with params: MTRGroupsClusterViewGroupParams, completionHandler: @escaping (MTRGroupsClusterViewGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
...
open class MTRClusterGroups: MTRGenericCluster {
    ...
    open func addGroupIfIdentifying(with params: MTRGroupsClusterAddGroupIfIdentifyingParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func addGroupIfIdentifying(with params: MTRGroupsClusterAddGroupIfIdentifyingParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func addGroup(with params: MTRGroupsClusterAddGroupParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping (MTRGroupsClusterAddGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func addGroup(with params: MTRGroupsClusterAddGroupParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping (MTRGroupsClusterAddGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func getGroupMembership(with params: MTRGroupsClusterGetGroupMembershipParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping (MTRGroupsClusterGetGroupMembershipResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func getGroupMembership(with params: MTRGroupsClusterGetGroupMembershipParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping (MTRGroupsClusterGetGroupMembershipResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func readAttributeNameSupport(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("NameSupport", params: params)
    }
    open func removeAllGroups(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func removeAllGroups(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func removeAllGroups(with params: MTRGroupsClusterRemoveAllGroupsParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func removeAllGroups(with params: MTRGroupsClusterRemoveAllGroupsParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func removeGroup(with params: MTRGroupsClusterRemoveGroupParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping (MTRGroupsClusterRemoveGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func removeGroup(with params: MTRGroupsClusterRemoveGroupParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping (MTRGroupsClusterRemoveGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func viewGroup(with params: MTRGroupsClusterViewGroupParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping (MTRGroupsClusterViewGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func viewGroup(with params: MTRGroupsClusterViewGroupParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping (MTRGroupsClusterViewGroupResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
...
open class MTRBaseClusterContentLauncher: MTRGenericBaseCluster {
    ...
    open class func readAttributeAcceptHeader(withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (attributeCacheContainer, endpoint, queue, completionHandler)
        mtrInvokeFailClosed(completionHandler)
    }
    open class func readAttributeAcceptHeader(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    ...
    open class func readAttributeSupportedStreamingProtocols(withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (attributeCacheContainer, endpoint, queue, completionHandler)
        mtrInvokeFailClosed(completionHandler)
    }
    open class func readAttributeSupportedStreamingProtocols(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open func launchContent(with params: MTRContentLauncherClusterLaunchContentParams, completion: @escaping (MTRContentLauncherClusterLauncherResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func launchContent(with params: MTRContentLauncherClusterLaunchContentParams, completionHandler: @escaping (MTRContentLauncherClusterLaunchResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func launchURL(with params: MTRContentLauncherClusterLaunchURLParams, completion: @escaping (MTRContentLauncherClusterLauncherResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func launchURL(with params: MTRContentLauncherClusterLaunchURLParams, completionHandler: @escaping (MTRContentLauncherClusterLaunchResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func readAttributeAcceptHeader(completion: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeAcceptHeader(completionHandler: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func readAttributeSupportedStreamingProtocols(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeSupportedStreamingProtocols(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func subscribeAttributeAcceptHeader(withMinInterval minInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished subscriptionEstablishedHandler: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (minInterval, maxInterval, params, subscriptionEstablishedHandler, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeAcceptHeader(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping ([Any]?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    ...
    open func subscribeAttributeSupportedStreamingProtocols(withMinInterval minInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished subscriptionEstablishedHandler: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (minInterval, maxInterval, params, subscriptionEstablishedHandler, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeSupportedStreamingProtocols(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func writeAttributeSupportedStreamingProtocols(withValue value: NSNumber, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (value, completion)
        mtrFailClosed(completion)
    }
    open func writeAttributeSupportedStreamingProtocols(withValue value: NSNumber, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (value, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func writeAttributeSupportedStreamingProtocols(withValue value: NSNumber, params: MTRWriteParams?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (value, params, completion)
        mtrFailClosed(completion)
    }
    open func writeAttributeSupportedStreamingProtocols(withValue value: NSNumber, params: MTRWriteParams?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (value, params, completionHandler)
        mtrFailClosed(completionHandler)
    }
...
open class MTRClusterContentLauncher: MTRGenericCluster {
    ...
    open func launchContent(with params: MTRContentLauncherClusterLaunchContentParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping (MTRContentLauncherClusterLauncherResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func launchContent(with params: MTRContentLauncherClusterLaunchContentParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping (MTRContentLauncherClusterLaunchResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func launchURL(with params: MTRContentLauncherClusterLaunchURLParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping (MTRContentLauncherClusterLauncherResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func launchURL(with params: MTRContentLauncherClusterLaunchURLParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping (MTRContentLauncherClusterLaunchResponseParams?, (any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func readAttributeAcceptHeader(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("AcceptHeader", params: params)
    }
    open func readAttributeAcceptedCommandList(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeSupportedStreamingProtocols(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("SupportedStreamingProtocols", params: params)
    }
    open func writeAttributeSupportedStreamingProtocols(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("SupportedStreamingProtocols", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeSupportedStreamingProtocols(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("SupportedStreamingProtocols", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    public convenience init?(device: MTRDevice, endpoint: UInt16, queue: dispatch_queue_t)
    {
        self.init(device: device, endpointID: NSNumber(value: endpoint), queue: queue)
...
open class MTRBaseClusterDeviceEnergyManagement: MTRGenericBaseCluster {
    ...
    open class func readAttributeAbsMaxPower(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeAbsMinPower(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    ...
    open class func readAttributeESACanGenerate(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeESAState(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeESAType(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    ...
    open class func readAttributeForecast(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (MTRDeviceEnergyManagementClusterForecastStruct?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    ...
    open class func readAttributeOptOutState(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributePowerAdjustmentCapability(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (MTRDeviceEnergyManagementClusterPowerAdjustCapabilityStruct?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open func cancelPowerAdjustRequest(completion: @escaping ((any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func cancelPowerAdjustRequest(with params: MTRDeviceEnergyManagementClusterCancelPowerAdjustRequestParams?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func cancelRequest(completion: @escaping ((any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func cancelRequest(with params: MTRDeviceEnergyManagementClusterCancelRequestParams?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func modifyForecastRequest(with params: MTRDeviceEnergyManagementClusterModifyForecastRequestParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func pauseRequest(with params: MTRDeviceEnergyManagementClusterPauseRequestParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func powerAdjustRequest(with params: MTRDeviceEnergyManagementClusterPowerAdjustRequestParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func readAttributeAbsMaxPower(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeAbsMinPower(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    ...
    open func readAttributeESACanGenerate(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeESAState(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeESAType(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    ...
    open func readAttributeForecast(completion: @escaping (MTRDeviceEnergyManagementClusterForecastStruct?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    ...
    open func readAttributeOptOutState(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributePowerAdjustmentCapability(completion: @escaping (MTRDeviceEnergyManagementClusterPowerAdjustCapabilityStruct?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func requestConstraintBasedForecast(with params: MTRDeviceEnergyManagementClusterRequestConstraintBasedForecastParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func resumeRequest(completion: @escaping ((any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func resumeRequest(with params: MTRDeviceEnergyManagementClusterResumeRequestParams?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func startTimeAdjustRequest(with params: MTRDeviceEnergyManagementClusterStartTimeAdjustRequestParams, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, completion)
        mtrFailClosed(completion)
    }
    open func subscribeAttributeAbsMaxPower(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeAbsMinPower(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    ...
    open func subscribeAttributeESACanGenerate(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeESAState(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeESAType(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    ...
    open func subscribeAttributeForecast(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (MTRDeviceEnergyManagementClusterForecastStruct?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    ...
    open func subscribeAttributeOptOutState(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributePowerAdjustmentCapability(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (MTRDeviceEnergyManagementClusterPowerAdjustCapabilityStruct?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
...
open class MTRClusterDeviceEnergyManagement: MTRGenericCluster {
    ...
    open func cancelPowerAdjustRequest(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func cancelPowerAdjustRequest(with params: MTRDeviceEnergyManagementClusterCancelPowerAdjustRequestParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func cancelRequest(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func cancelRequest(with params: MTRDeviceEnergyManagementClusterCancelRequestParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func modifyForecastRequest(with params: MTRDeviceEnergyManagementClusterModifyForecastRequestParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func pauseRequest(with params: MTRDeviceEnergyManagementClusterPauseRequestParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func powerAdjustRequest(with params: MTRDeviceEnergyManagementClusterPowerAdjustRequestParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func readAttributeAbsMaxPower(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("AbsMaxPower", params: params)
    }
    open func readAttributeAbsMinPower(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("AbsMinPower", params: params)
    }
    open func readAttributeAcceptedCommandList(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeESACanGenerate(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("ESACanGenerate", params: params)
    }
    open func readAttributeESAState(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("ESAState", params: params)
    }
    open func readAttributeESAType(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("ESAType", params: params)
    }
    open func readAttributeFeatureMap(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeForecast(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("Forecast", params: params)
    }
    open func readAttributeGeneratedCommandList(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeOptOutState(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("OptOutState", params: params)
    }
    open func readAttributePowerAdjustmentCapability(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("PowerAdjustmentCapability", params: params)
    }
    open func requestConstraintBasedForecast(with params: MTRDeviceEnergyManagementClusterRequestConstraintBasedForecastParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func resumeRequest(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func resumeRequest(with params: MTRDeviceEnergyManagementClusterResumeRequestParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func startTimeAdjustRequest(with params: MTRDeviceEnergyManagementClusterStartTimeAdjustRequestParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
...
open class MTRBaseClusterSwitch: MTRGenericBaseCluster {
    ...
    open class func readAttributeCurrentPosition(withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (attributeCacheContainer, endpoint, queue, completionHandler)
        mtrInvokeFailClosed(completionHandler)
    }
    open class func readAttributeCurrentPosition(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    ...
    open class func readAttributeMultiPressMax(withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (attributeCacheContainer, endpoint, queue, completionHandler)
        mtrInvokeFailClosed(completionHandler)
    }
    open class func readAttributeMultiPressMax(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    open class func readAttributeNumberOfPositions(withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (attributeCacheContainer, endpoint, queue, completionHandler)
        mtrInvokeFailClosed(completionHandler)
    }
    open class func readAttributeNumberOfPositions(withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (clusterStateCacheContainer, endpoint, queue, completion)
        mtrInvokeFailClosed(completion)
    }
    ...
    open func readAttributeCurrentPosition(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeCurrentPosition(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func readAttributeMultiPressMax(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeMultiPressMax(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func readAttributeNumberOfPositions(completion: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completion)
        mtrFailClosed(completion)
    }
    open func readAttributeNumberOfPositions(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func subscribeAttributeCurrentPosition(withMinInterval minInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished subscriptionEstablishedHandler: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (minInterval, maxInterval, params, subscriptionEstablishedHandler, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeCurrentPosition(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    ...
    open func subscribeAttributeMultiPressMax(withMinInterval minInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished subscriptionEstablishedHandler: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (minInterval, maxInterval, params, subscriptionEstablishedHandler, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeMultiPressMax(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeNumberOfPositions(withMinInterval minInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished subscriptionEstablishedHandler: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (minInterval, maxInterval, params, subscriptionEstablishedHandler, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
    open func subscribeAttributeNumberOfPositions(with params: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: @escaping (NSNumber?, (any Error)?) -> Void)
    {
        _ = (params, subscriptionEstablished, reportHandler)
        mtrSubscribeFailClosed(reportHandler)
    }
...
open class MTRClusterSwitch: MTRGenericCluster {
    ...
    open func readAttributeCurrentPosition(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("CurrentPosition", params: params)
    }
    open func readAttributeFeatureMap(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeMultiPressMax(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("MultiPressMax", params: params)
    }
    open func readAttributeNumberOfPositions(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("NumberOfPositions", params: params)
    }
    public convenience init?(device: MTRDevice, endpoint: UInt16, queue: dispatch_queue_t)
    {
        self.init(device: device, endpointID: NSNumber(value: endpoint), queue: queue)
...
open class MTRClusterLevelControl: MTRGenericCluster {
    ...
    open func moveToClosestFrequency(with params: MTRLevelControlClusterMoveToClosestFrequencyParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func moveToClosestFrequency(with params: MTRLevelControlClusterMoveToClosestFrequencyParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func moveToLevelWithOnOff(with params: MTRLevelControlClusterMoveToLevelWithOnOffParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func moveToLevelWithOnOff(with params: MTRLevelControlClusterMoveToLevelWithOnOffParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func moveToLevel(with params: MTRLevelControlClusterMoveToLevelParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func moveToLevel(with params: MTRLevelControlClusterMoveToLevelParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func moveWithOnOff(with params: MTRLevelControlClusterMoveWithOnOffParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func moveWithOnOff(with params: MTRLevelControlClusterMoveWithOnOffParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func move(with params: MTRLevelControlClusterMoveParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func move(with params: MTRLevelControlClusterMoveParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func readAttributeCurrentFrequency(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("CurrentFrequency", params: params)
    }
    open func readAttributeCurrentLevel(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeDefaultMoveRate(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("DefaultMoveRate", params: params)
    }
    open func readAttributeFeatureMap(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeMaxFrequency(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("MaxFrequency", params: params)
    }
    ...
    open func readAttributeMinFrequency(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("MinFrequency", params: params)
    }
    ...
    open func readAttributeOffTransitionTime(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("OffTransitionTime", params: params)
    }
    open func readAttributeOnLevel(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("OnLevel", params: params)
    }
    open func readAttributeOnOffTransitionTime(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("OnOffTransitionTime", params: params)
    }
    open func readAttributeOnTransitionTime(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("OnTransitionTime", params: params)
    }
    open func readAttributeOptions(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("Options", params: params)
    }
    open func readAttributeRemainingTime(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("RemainingTime", params: params)
    }
    open func readAttributeStartUpCurrentLevel(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("StartUpCurrentLevel", params: params)
    }
    open func stepWithOnOff(with params: MTRLevelControlClusterStepWithOnOffParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func stepWithOnOff(with params: MTRLevelControlClusterStepWithOnOffParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func step(with params: MTRLevelControlClusterStepParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func step(with params: MTRLevelControlClusterStepParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func stopWithOnOff(with params: MTRLevelControlClusterStopWithOnOffParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func stopWithOnOff(with params: MTRLevelControlClusterStopWithOnOffParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func stop(with params: MTRLevelControlClusterStopParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func stop(with params: MTRLevelControlClusterStopParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func writeAttributeDefaultMoveRate(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("DefaultMoveRate", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeDefaultMoveRate(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("DefaultMoveRate", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    open func writeAttributeOffTransitionTime(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("OffTransitionTime", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeOffTransitionTime(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("OffTransitionTime", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    open func writeAttributeOnLevel(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("OnLevel", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeOnLevel(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("OnLevel", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    open func writeAttributeOnOffTransitionTime(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("OnOffTransitionTime", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeOnOffTransitionTime(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("OnOffTransitionTime", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    open func writeAttributeOnTransitionTime(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("OnTransitionTime", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeOnTransitionTime(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("OnTransitionTime", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    open func writeAttributeOptions(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("Options", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeOptions(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("Options", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    open func writeAttributeStartUpCurrentLevel(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("StartUpCurrentLevel", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeStartUpCurrentLevel(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("StartUpCurrentLevel", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    public convenience init?(device: MTRDevice, endpoint: UInt16, queue: dispatch_queue_t)
    {
        self.init(device: device, endpointID: NSNumber(value: endpoint), queue: queue)
...
open class MTRClusterWindowCovering: MTRGenericCluster {
    ...
    open func downOrClose(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func downOrClose(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func downOrClose(with params: MTRWindowCoveringClusterDownOrCloseParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func downOrClose(with params: MTRWindowCoveringClusterDownOrCloseParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func goToLiftPercentage(with params: MTRWindowCoveringClusterGoToLiftPercentageParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func goToLiftPercentage(with params: MTRWindowCoveringClusterGoToLiftPercentageParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func goToLiftValue(with params: MTRWindowCoveringClusterGoToLiftValueParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func goToLiftValue(with params: MTRWindowCoveringClusterGoToLiftValueParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func goToTiltPercentage(with params: MTRWindowCoveringClusterGoToTiltPercentageParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func goToTiltPercentage(with params: MTRWindowCoveringClusterGoToTiltPercentageParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func goToTiltValue(with params: MTRWindowCoveringClusterGoToTiltValueParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func goToTiltValue(with params: MTRWindowCoveringClusterGoToTiltValueParams, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    ...
    open func readAttributeConfigStatus(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("ConfigStatus", params: params)
    }
    open func readAttributeCurrentPositionLiftPercent100ths(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("CurrentPositionLiftPercent100ths", params: params)
    }
    open func readAttributeCurrentPositionLiftPercentage(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("CurrentPositionLiftPercentage", params: params)
    }
    open func readAttributeCurrentPositionLift(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("CurrentPositionLift", params: params)
    }
    open func readAttributeCurrentPositionTiltPercent100ths(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("CurrentPositionTiltPercent100ths", params: params)
    }
    open func readAttributeCurrentPositionTiltPercentage(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("CurrentPositionTiltPercentage", params: params)
    }
    open func readAttributeCurrentPositionTilt(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("CurrentPositionTilt", params: params)
    }
    open func readAttributeEndProductType(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("EndProductType", params: params)
    }
    open func readAttributeFeatureMap(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
    ...
    open func readAttributeInstalledClosedLimitLift(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("InstalledClosedLimitLift", params: params)
    }
    open func readAttributeInstalledClosedLimitTilt(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("InstalledClosedLimitTilt", params: params)
    }
    open func readAttributeInstalledOpenLimitLift(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("InstalledOpenLimitLift", params: params)
    }
    open func readAttributeInstalledOpenLimitTilt(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("InstalledOpenLimitTilt", params: params)
    }
    open func readAttributeMode(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("Mode", params: params)
    }
    open func readAttributeNumberOfActuationsLift(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("NumberOfActuationsLift", params: params)
    }
    open func readAttributeNumberOfActuationsTilt(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("NumberOfActuationsTilt", params: params)
    }
    open func readAttributeOperationalStatus(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("OperationalStatus", params: params)
    }
    open func readAttributePhysicalClosedLimitLift(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("PhysicalClosedLimitLift", params: params)
    }
    open func readAttributePhysicalClosedLimitTilt(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("PhysicalClosedLimitTilt", params: params)
    }
    open func readAttributeSafetyStatus(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("SafetyStatus", params: params)
    }
    open func readAttributeTargetPositionLiftPercent100ths(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("TargetPositionLiftPercent100ths", params: params)
    }
    open func readAttributeTargetPositionTiltPercent100ths(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("TargetPositionTiltPercent100ths", params: params)
    }
    open func readAttributeType(with params: MTRReadParams?) -> [String : Any]?
    {
        _ = (params)
        return mtrHostRead("Type", params: params)
    }
    open func stopMotion(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func stopMotion(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func stopMotion(with params: MTRWindowCoveringClusterStopMotionParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func stopMotion(with params: MTRWindowCoveringClusterStopMotionParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func upOrOpen(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func upOrOpen(withExpectedValues expectedValues: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (expectedValues, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func upOrOpen(with params: MTRWindowCoveringClusterUpOrOpenParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completion: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completion)
        mtrFailClosed(completion)
    }
    open func upOrOpen(with params: MTRWindowCoveringClusterUpOrOpenParams?, expectedValues expectedDataValueDictionaries: [[String : Any]]?, expectedValueInterval expectedValueIntervalMs: NSNumber?, completionHandler: @escaping ((any Error)?) -> Void)
    {
        _ = (params, expectedDataValueDictionaries, expectedValueIntervalMs, completionHandler)
        mtrFailClosed(completionHandler)
    }
    open func writeAttributeMode(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber)
    {
        mtrHostWrite("Mode", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: nil)
    }
    open func writeAttributeMode(withValue dataValueDictionary: [String : Any], expectedValueInterval expectedValueIntervalMs: NSNumber, params: MTRWriteParams?)
    {
        mtrHostWrite("Mode", value: dataValueDictionary, expectedValueInterval: expectedValueIntervalMs, params: params)
    }
    public convenience init?(device: MTRDevice, endpoint: UInt16, queue: dispatch_queue_t)
    {
        self.init(device: device, endpointID: NSNumber(value: endpoint), queue: queue)
