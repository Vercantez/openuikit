...
- Create `tests/agent/IOSurfaceRuntime.swift`. It must import `IOSurface`, exercise
  meaningful implemented behavior, and print exactly `IOSURFACE_AGENT_RUNTIME_OK` on success.
