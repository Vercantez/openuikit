...
The immutable seed contains 9510 unique public precise identifiers and
10645 symbol-graph relationships. The acceptance floor is
...
4. `tests/agent/MapKitRuntime.swift`, meaningful focused tests, and the exact
   success marker `MAPKIT_AGENT_RUNTIME_OK`.
