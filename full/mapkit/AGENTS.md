...
- Create `tests/agent/MapKitRuntime.swift`. It must import `MapKit`, exercise
  meaningful implemented behavior, and print exactly `MAPKIT_AGENT_RUNTIME_OK` on success.
