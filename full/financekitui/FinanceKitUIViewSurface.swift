...
// Identity View modifiers that exist because TransactionPicker and
// AddOrderToWalletButton conform to View. Linux has no SwiftUI layout
// engine; these compile as no-ops so the synthesized census can be
// declared without inventing layout.
