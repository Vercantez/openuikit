...
PY
    ...
    local url_transport_host dispatch_host dispatch_runtime blocks_runtime relative_time_host foundation_intl_host compression_host zlib_host
    ...
    zlib_host=$guest_root/host/libOpenZlibHost.so
    ...
    require_regular "$zlib_host" "Linux zlib helper"
    ...
    (
        ...
        LD_PRELOAD="$dispatch_host:$foundation_intl_host:$url_transport_host:$relative_time_host:$compression_host:$zlib_host${LD_PRELOAD:+:$LD_PRELOAD}" \
