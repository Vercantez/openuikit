...
/// real module is imported; the isolated host has no SwiftUI, so TipKit
...
extension View {
    ...
    public func popoverTip(_ p0: Any? = nil) -> Self { self }
    ...
    public func tipAnchor(_ p0: Any? = nil) -> Self { self }
    public func tipBackground(_ p0: Any? = nil) -> Self { self }
    public func tipBackgroundInteraction(_ p0: Any? = nil) -> Self { self }
    public func tipCornerRadius(_ p0: Any? = nil) -> Self { self }
    public func tipImageSize(_ p0: Any? = nil) -> Self { self }
    public func tipImageStyle(_ p0: Any? = nil) -> Self { self }
    public func tipViewStyle(_ p0: Any? = nil) -> Self { self }
