...
func testQueryPredicateBuilders() {
    ...
    _ = HKQuery.predicateForObjects(withMetadataKey: HKMetadataKeyWasUserEntered, operatorType: HKPredicateOperator.equalTo, value: true)
    ...
    _ = HKQuery.predicateForCategorySamples(with: HKPredicateOperator.equalTo, value: 1)
    _ = HKQuery.predicateForQuantitySamples(with: HKPredicateOperator.greaterThan, quantity: HKQuantity(unit: .count(), doubleValue: 1))
    ...
    _ = HKQuery.predicateForWorkouts(with: HKPredicateOperator.greaterThan, duration: 1)
    _ = HKQuery.predicateForWorkouts(with: HKPredicateOperator.greaterThan, totalDistance: HKQuantity(unit: .meter(), doubleValue: 1))
    _ = HKQuery.predicateForWorkouts(with: HKPredicateOperator.greaterThan, totalEnergyBurned: HKQuantity(unit: .kilocalorie(), doubleValue: 1))
    _ = HKQuery.predicateForWorkouts(with: HKPredicateOperator.greaterThan, totalFlightsClimbed: HKQuantity(unit: .count(), doubleValue: 1))
    _ = HKQuery.predicateForWorkouts(with: HKPredicateOperator.greaterThan, totalSwimmingStrokeCount: HKQuantity(unit: .count(), doubleValue: 1))
    ...
    _ = HKQuery.predicateForWorkoutActivities(operatorType: HKPredicateOperator.greaterThan, duration: 1)
    ...
    _ = HKQuery.predicateForStatesOfMind(withValence: 0, operatorType: HKPredicateOperator.equalTo)
