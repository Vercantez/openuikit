...
- Create `tests/agent/AdSupportRuntime.swift`. It must import `AdSupport`, exercise
  meaningful implemented behavior, and print exactly `ADSUPPORT_AGENT_RUNTIME_OK` on success.
