...
/// real module is imported; the isolated host has no SwiftUI, so the
/// SceneKit overlay `SceneView` exposes the method names from the canonical
...
enum _SceneKitViewSurfaceMarker {}
