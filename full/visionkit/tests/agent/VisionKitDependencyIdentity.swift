...
func visionKitDependencyIdentityProbe() async {
...
extension ImageAnalysisInteraction {
    fileprivate func regionProbe(_ rect: CGRect) {
...
await visionKitDependencyIdentityProbe()
