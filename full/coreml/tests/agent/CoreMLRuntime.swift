...
enum CoreMLRuntime {
    static func main() {
        ...
        testCustomModelProtocolAndBatchDefault()
        ...
        testIntegerOverlayComparisonsAndRanges()
        testIntegerOverlayArithmeticAndOverflow()
        testIntegerOverlayBitwiseAndShifts()
        testIntegerOverlayInitializersAndConversions()
        testIntegerOverlayPropertiesAndEndian()
        testIntegerOverlayStrideAndDistance()
        testIntegerOverlayRandomRanges()
        testIntegerOverlayFormattingAndParsing()
