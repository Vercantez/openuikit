...
# The keyboard is a remote process: only the framebuffer shows it. The
# harness leaves the app in the typed state (URL field focused, "mozilla").
xcrun simctl io "$UDID" screenshot "$OUT/focus_edit.typed.framebuffer.png" >/dev/null 2>&1 || true
