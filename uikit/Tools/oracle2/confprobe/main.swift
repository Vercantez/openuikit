...
//   <app>.t<ms>.layout.json  {"name", "t", "style", "contentSize", "clock", "screen", "views"}
...
/// dark without rewriting it. `CONFPROBE_CONTENT_SIZE` (`ax1` / `xxxl`)
...
func loadScript() -> (steps: [(t: Double, action: String)], captures: [Double],
    ...
    return (steps, captures, style, contentSize)
}
...
final class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func application(_ app: UIApplication,
        ...
        (steps, captures, style, contentSize) = loadScript()
        ...
        print("confprobe: style=\(style) contentSize=\(contentSize)")
