...
func capture(at t: Double, frame: Int, link: CADisplayLink,
        ...
        // orientation belongs on this first call (main's --landscape axis):
        // NEED_SHOT writes pngName, so a focused landscape capture must
        // already carry `.landscape`. merge-keyboard2 restored contentSize
        // the same way after the keyboard's older 3-arg form dropped it.
