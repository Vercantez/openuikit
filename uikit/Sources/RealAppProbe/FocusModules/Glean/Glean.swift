...
import Foundation
// MEASURED mozilla-mobile/focus-ios a2832521 NavigationPath.swift:5–6
// imports Foundation + Glean only, then names `UIApplication`. Launch's
// Glean re-exported UIKit so that file compiled unmodified. Keep that
// export on top of focus-deps's fuller Glean surface.
