...
// is `Selector.named` plus FocusSelectors.swift; `private` is widened on the
// dispatched method so the table can reference it. scripts/realapp_probe_sim.sh
...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        rotated()
        NotificationCenter.default.addObserver(self, selector: Selector.named("rotated"), name: UIDevice.orientationDidChangeNotification, object: nil)
