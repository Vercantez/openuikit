...
// The guest drag-and-drop identity now lives in the Foundation umbrella
// (full/foundation/NSExtensionHost.swift subclasses OpenUIKit.NSItemProvider;
// full/foundation/Progress.swift supplies UIDropSession.loadObjects). The
// overlay simplenote-launch added here duplicated both and made
// BrowserViewController.swift:1193 "ambiguous use of loadObjects" on the x86
// guest route (verify89 rungs b/c); removed 2026-09-17.
