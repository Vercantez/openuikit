...
public final class NimbusDisabled: NimbusInterface {
    public var globalUserParticipation = true
    public init() {}
...
public extension Bundle {
    /// Used by Blockzilla NimbusWrapper. Not in Apple Foundation; lives on
    /// the AppServices bundle helper. Returning nil is honest: there is no
    /// packaged translation fallback next to this host.
    func fallbackTranslationBundle(language: String) -> Bundle? {
        _ = language
        return nil
    }
}
