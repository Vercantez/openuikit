...
// ADAPTED(library-target): @UIApplicationMain stripped so this file
// compiles into the Blockzilla library. The harness calls
// OpenUIKit.UIApplicationMain(delegate: AppDelegate()). Corpus a2832521
// is unchanged.
