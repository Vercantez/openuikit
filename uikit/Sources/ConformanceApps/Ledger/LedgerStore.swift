...
nonisolated enum LedgerStore {
    ...
    static func durationString(_ seconds: TimeInterval) -> String {
        ...
        #else
        // swift-corelibs-foundation marks DateComponentsFormatter unavailable
        // (Docker verify 65 on main after the Ledger merge: "'DateComponentsFormatter'
        // is unavailable"). Same shape as the guest golden dcf.abbr.en_US:
        // hours+minutes, leading zero unit dropped ("2h 15m", "15m").
