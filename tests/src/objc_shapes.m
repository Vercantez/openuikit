/* objc_shapes -- the `objc_shapes` rung: Objective-C draws, in anger.
 *
 * quartz proved the rasteriser under machorun with no Objective-C in it.
 * objc proved Objective-C under machorun with no drawing in it. objc_quartz
 ...
 *                       from class_createInstance(), exactly as in objc.
